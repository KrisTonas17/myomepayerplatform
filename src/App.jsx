        ...
        <div style={{ maxWidth: 780 }}>
          ...
          <div style={{
            ...
            {[
              ...
              { number: '~17%', label: 'Avg Actionable Finding Rate', color: C.amber },
            ].map(s => (
              <div key={s.label}>
...
function WhatWeScreen() {
  ...
  return (
    <section style={{ padding: '100px 0', background: C.bgNavy, position: 'relative' }}>
      ...
      <div style={{ ...sectionWrap, position: 'relative' }}>
        <div style={{ textAlign: 'center', marginBottom: 64 }}>
          <div style={{ ...pill(C.blue), marginBottom: 16 }}>What We Screen</div>
          <h2 style={{
            fontFamily: fontDisplay, fontSize: 'clamp(28px, 4vw, 44px)',
            fontWeight: 800, letterSpacing: '-0.02em', color: C.textPrimary, lineHeight: 1.1,
          }}>151 genes across four<br />clinically validated categories</h2>
          <p style={{ color: C.textSecondary, fontSize: 17, maxWidth: 540, margin: '16px auto 0', fontWeight: 300, lineHeight: 1.65 }}>
            Every gene in the panel was selected for clinical validity, actionability, and real-world impact. Nothing is reported unless a member can act on it.
          </p>
        </div>
        ...
        <div style={{
          ...
          <div style={{ padding: '32px', borderBottom: `1px solid ${C.borderSubtle}`, display: 'flex', alignItems: 'center', gap: 16 }}>
            ...
            <div>
              ...
              <p style={{ color: categories[open].color, fontSize: 13, fontWeight: 600, marginTop: 2 }}>Selected conditions included in this category</p>
            </div>
          </div>
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: 0 }}>
            <div style={{ padding: '28px 32px' }}>
              <ul style={{ listStyle: 'none', display: 'flex', flexDirection: 'column', gap: 12 }}>
                {categories[open].conditions.map((c, i) => (
  ...
  const paths = [
    {
      ...
      badgeColor: C.green,
      icon: '🏢',
      title: 'Employer & ASO Innovation',
      subtitle: 'Differentiate your commercial offering. Win and retain your largest employer accounts.',
      who: 'Built for commercial/national accounts, ASO employer solutions teams, Optum-style employer benefit platforms, and benefits consultants.',
      problem: 'Large employers are under relentless pressure to control rising health costs while competing for talent with differentiated benefits. Standard wellness programs are failing to engage employees and proving limited clinical value. Benefits leaders need something that actually feels premium and personal.',
      whatItIs: 'A precision-prevention benefit that employers can offer to their workforce. Members receive whole-genome sequencing with personalized risk reports covering cancer, cardiovascular, and medication risks. The employer receives de-identified population-level insights only — individual data never flows to HR or benefits leadership.',
      valueProp: [
        'A benefits differentiator that employees notice and remember',
        ...
        'Stronger employer account retention for the plan',
        'Executive health enhancement tier available for leadership populations',
      ],
      pilotStart: 'A single strategic ASO employer — 2,000 to 10,000 eligible lives — with a voluntary participation pilot designed around clear success metrics.',
      timeToValue: 'Engagement and member satisfaction visible within 60–90 days of launch. Medication optimization signals within 6 months. Prevention and risk data building from day one.',
    },
    {
      badge: 'Fastest ROI',
      badgeColor: C.amber,

    ...
    <section style={{
      ...
      <div style={{ ...sectionWrap, position: 'relative', zIndex: 1, width: '100%' }}>
        <div style={{ maxWidth: 780 }}>
          ...
          {/* Stats bar */}
          <div style={{
            display: 'flex', gap: isMobile ? 24 : 40, marginTop: isMobile ? 40 : 64, flexWrap: 'wrap',
            paddingTop: isMobile ? 28 : 40, borderTop: `1px solid ${C.borderSubtle}`,
...
function ProblemSection() {
  ...
  return (
    <section style={{ padding: isMobile ? '64px 0' : '100px 0', background: C.bgNavy, position: 'relative', overflow: 'hidden' }}>
      <div style={{
...
function HowItWorks() {
  ...
  return (
    <section id="how-it-works" style={{ padding: isMobile ? '64px 0' : '100px 0', background: C.bgDeep, position: 'relative', overflow: 'hidden' }}>
      <div style={{
        position: 'absolute', inset: 0,
...
function WhatWeScreen() {
  ...
  return (
    <section style={{ padding: isMobile ? '64px 0' : '100px 0', background: C.bgNavy, position: 'relative' }}>
      <div style={{
        position: 'absolute', inset: 0,
...
function PartnershipPaths() {
  ...
  return (
    <section id="pathways" style={{ padding: isMobile ? '64px 0' : '100px 0', background: C.bgDeep, position: 'relative', overflow: 'hidden' }}>
      <div style={{
        position: 'absolute', inset: 0,
...
function ROIExplorer() {
  ...
  return (
    <section id="roi" style={{ padding: isMobile ? '64px 0' : '100px 0', background: C.bgNavy, position: 'relative', overflow: 'hidden' }}>
      <div style={{
        position: 'absolute', inset: 0,
      ...
      <div style={{ ...sectionWrap, position: 'relative' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: isMobile ? '1fr' : 'minmax(280px, 380px) 1fr', gap: 24, alignItems: 'start' }}>
          {/* Controls */}
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 16, minWidth: 0 }}>
            {/* Metric cards — always 2x2 grid for a clean layout on all screen sizes */}
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: 12 }}>
              {pd.metrics.map((m, i) => (
                <div key={`${pathway}-${i}`} style={{
                  ...
                  <div style={{
                    fontFamily: fontDisplay, fontSize: isMobile ? 24 : 28, fontWeight: 800,
                  ...
                  <div style={{ color: C.textMuted, fontSize: 11, lineHeight: 1.5, fontWeight: 300 }}>{m.sub}</div>
                </div>
              ))}
            </div>

            {/* Industry benchmarks */}
            <div style={{ background: C.bgCard, borderRadius: 14, padding: '24px', border: `1px solid ${C.border}`, minWidth: 0 }}>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
                {pd.benchmarks.map((b, i) => (
                  <div key={i} style={{
                    ...
                    flexDirection: isMobile ? 'column' : 'row',
                    justifyContent: 'space-between', gap: isMobile ? 4 : 12,
                    ...
                    <div style={{ textAlign: isMobile ? 'left' : 'right', flexShrink: 0 }}>
                      <span style={{ fontFamily: fontDisplay, fontWeight: 700, color: pd.color, fontSize: 15 }}>{b.value}</span>
            ...
            {(() => {
              ...
              return (
                <div style={{
                  ...
                  borderRadius: 14, padding: '28px 24px', minWidth: 0,
                }}>
                  ...
                  {/* Scenarios — auto-fit so they wrap naturally on any screen width */}
                  <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(120px, 1fr))', gap: 10 }}>
                    {scenarios.map((s, i) => (
                      <div key={i} style={{
                        background: s.bg, borderRadius: 10, padding: '16px 12px', textAlign: 'center',
                        border: `1px solid ${s.color}25`,
                        animation: 'count-up 0.4s ease both',
                        minWidth: 0,
                      }}>
                        <div style={{ fontSize: 10, fontWeight: 700, color: s.color === C.textSecondary ? C.textMuted : s.color, letterSpacing: '0.06em', textTransform: 'uppercase', fontFamily: fontDisplay, marginBottom: 8 }}>{s.label}</div>
                        <div style={{ fontFamily: fontDisplay, fontSize: isMobile ? 16 : 20, fontWeight: 800, color: s.color, lineHeight: 1 }}>
                          {fmt(s.low)}
                        </div>
...
function PathwayFinder() {
  ...
  return (
    <section id="finder" style={{ padding: isMobile ? '64px 0' : '100px 0', background: C.bgDeep, position: 'relative', overflow: 'hidden' }}>
      <div style={{
        position: 'absolute', inset: 0,
      ...
      <div style={{ ...sectionWrap, position: 'relative' }}>
        ...
        <div style={{ maxWidth: 720, margin: '0 auto' }}>
          ...
          {!result ? (
            <div style={{
              background: C.bgCard, borderRadius: 20,
              border: `1px solid ${C.border}`, padding: isMobile ? '28px 20px' : '40px 36px',
              ...
              <h3 style={{ fontFamily: fontDisplay, fontSize: isMobile ? 18 : 22, fontWeight: 700, color: C.textPrimary, marginBottom: isMobile ? 20 : 32, lineHeight: 1.3 }}>
                {questions[step].q}
              </h3>
              <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
            ...
            <div style={{
              background: C.bgCard, borderRadius: 20,
              border: `1px solid ${result.color}40`, padding: isMobile ? '28px 20px' : '40px 36px',
              animation: 'fadeUp 0.4s ease both',
            }}>
              <div style={{ textAlign: 'center', marginBottom: 32 }}>
                ...
                <h3 style={{ fontFamily: fontDisplay, fontSize: isMobile ? 22 : 28, fontWeight: 800, color: C.textPrimary, marginBottom: 8, letterSpacing: '-0.02em' }}>
                  {result.path}
                </h3>
              </div>
...
function PrivacyTrust() {
  ...
  return (
    <section id="privacy" style={{ padding: isMobile ? '64px 0' : '100px 0', background: C.bgNavy, position: 'relative', overflow: 'hidden' }}>
      <div style={{
        position: 'absolute', inset: 0,
...
function LongGame() {
  const isMobile = useIsMobile()
  return (
    <section style={{ padding: isMobile ? '64px 0' : '100px 0', background: C.bgDeep, position: 'relative', overflow: 'hidden' }}>
      <div style={{
        position: 'absolute', inset: 0,
      ...
      <div style={{ ...sectionWrap, position: 'relative' }}>
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: isMobile ? 36 : 64, alignItems: 'center' }}>
          <div>
  ...
  return (
    <section id="contact" style={{
      ...
      <div style={{ ...sectionWrap, textAlign: 'center', position: 'relative' }}>
        ...
        <div style={{ display: 'flex', gap: isMobile ? 16 : 32, justifyContent: 'center', flexWrap: 'wrap', flexDirection: isMobile ? 'column' : 'row', alignItems: isMobile ? 'flex-start' : 'center', maxWidth: isMobile ? 280 : 'none', margin: '0 auto' }}>
          {[
  ...
  return (
    <footer style={{
      ...
      <div style={{
        ...sectionWrap,
        display: 'flex', alignItems: isMobile ? 'flex-start' : 'center',
        justifyContent: 'space-between', flexWrap: 'wrap', gap: isMobile ? 16 : 20,
        flexDirection: isMobile ? 'column' : 'row',
      }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: 10, flexWrap: 'wrap' }}>
          ...
          {!isMobile && <span style={{ color: C.textMuted, fontSize: 13 }}>— Precision Prevention for Health Plans & Payers</span>}
        </div>
